...
public class CCalculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        shapeComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "AR111", "MR11 GU4", "MR16 GU 5.3", "PAR16", "PAR20", "PAR25", "PAR30S", "PAR36", "PAR38", "R50/NR50", "R63/NR63", "R80/NR80", "R95/NR95", "R125" }));
        ...
        if (!lumenTextField.getText().isEmpty() && !pratedTextField.getText().isEmpty()) {
            ...
            if (ndirRadioButton.isSelected()) {
                ...
                try {
                    ...
                    method = getClass().getDeclaredMethod(shapeComboBox.getSelectedItem().toString(), paramTypes);
                    method.invoke(this, corrfactor);
                } catch (IllegalAccessException ex) {
                    Logger.getLogger(CCalculator.class.getName()).log(Level.SEVERE, null, ex);
